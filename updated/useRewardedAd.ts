...
export function useRewardedAd() {
  ...
  return {
    ...
    // state before the user taps the button, not a loading state. Nothing
    // preloads the ad, so treating idle as "loading" left the button stuck
    // showing a spinner (and callers gating on !loading) forever.
